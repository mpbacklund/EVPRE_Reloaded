...
class RouteEstimator:
    ...
    def get_shortest_path(self):
        start_node = ox.nearest_nodes(self.graph, self.starting_coord[1], self.starting_coord[0])  # Location 1
        end_node = ox.nearest_nodes(self.graph, self.ending_coord[1], self.ending_coord[0])  # Location 2
